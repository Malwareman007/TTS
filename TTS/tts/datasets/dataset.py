# --Vanisha has changed shuffle value to be true at 2 instances"
import base64
import collections
import os
import random
    ...
    def precompute(self, num_workers=1):
        ...
        with tqdm.tqdm(total=len(self)) as pbar:
            ...
            dataloder = torch.utils.data.DataLoader(
                batch_size=batch_size, dataset=self, shuffle=True, num_workers=num_workers, collate_fn=self.collate_fn
            )
            for _ in dataloder:
