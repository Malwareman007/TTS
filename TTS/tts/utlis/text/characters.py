...
# _character = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
_characters = "अ आ इ ई उ ऊ ऋ ऍ ए ऐ ऑ ओ औ अं अः क ख ग घ ङ च छ ज झ ञ ट ठ ड ढ ण त थ द ध न प फ ब भ म य र ल व श ष स ह क़ ख़ ग़ ज़ ड़ ढ़ फ़ का कि की कु कू कृ के कै कॉ को कौ कँ कं कः खा खि खी खु खू खृ खॅ खे खै खॉ खो खौ खँ खं खः गा गि गी गु गू गृ गॅ गे गै गॉ गो गौ गँ गं गः घा घि घी घु घू घृ घॅ घे घै घॉ घो घौ घँ घं घः ङा ङि ङी ङु ङू ङृ ङॅ ङे ङै ङॉ ङो ङौ ङँ ङं ङः चा चि ची चु चू चृ चॅ चे चै चॉ चो चौ चँ चं चः छा छि छी छु छू छृ छॅ छे छै छॉ छो छौ छँ छं छः जा जि जी जु जू जृ जॅ जे जै जॉ जो जौ जँ जं जः झा झि झी झु झू झृ झॅ झे झै झॉ झो झौ झँ झं झः ञा ञि ञी ञु ञू ञृ ञॅ ञे ञै ञॉ ञो ञौ ञँ ञं ञः टा टि टी टु टू टृ टॅ टे टै टॉ टो टौ टँ टं टः ठा ठि ठी ठु ठू ठृ ठॅ ठे ठै ठॉ ठो ठौ ठँ ठं ठः डा डि डी डु डू डृ डॅ डे डै डॉ डो डौ डँ डं डः ढा ढि ढी ढु ढू ढृ ढॅ ढे ढै ढॉ ढो ढौ ढँ ढं ढः णा णि णी णु णू णृ णॅ णे णै णॉ णो णौ णँ णं णः ता ति ती तु तू तृ तॅ ते तै तॉ तो तौ तँ तं तः था थि थी थु थू थृ थॅ थे थै थॉ थो थौ थँ थं थः दा दि दी दु दू दृ दॅ दे दै दॉ दो दौ दँ दं दः धा धि धी धु धू धृ धॅ धे धै धॉ धो धौ धँ धं धः ना नि नी नु नू नृ नॅ ने नै नॉ नो नौ नँ नं नः पा पि पी पु पू पृ पॅ पे पै पॉ पो पौ पँ पं पः फा फि फी फु फू फृ फॅ फे फै फॉ फो फौ फँ फं फः बा बि बी बु बू बृ बॅ बे बै बॉ बो बौ बँ बं बः भा भि भी भु भू भृ भॅ भे भै भॉ भो भौ भँ भं भः मा मि मी मु मू मृ मॅ मे मै मॉ मो मौ मँ मं मः या यि यी यु यू यृ यॅ ये यै यॉ यो यौ यँ यं यः रा रि री रु रू रृ रॅ रे रै रॉ रो रौ रँ रं रः ला लि ली लु लू लृ लॅ ले लै लॉ लो लौ लँ लं लः वा वि वी वु वू वृ वॅ वे वै वॉ वो वौ वँ वं वः शा शि शी शु शू शृ शॅ शे शै शॉ शो शौ शँ शं शः षा षि षी षु षू षृ षॅ षे षै षॉ षो षौ षँ षं षः सा सि सी सु सू सृ सॅ से सै सॉ सो सौ सँ सं सः हा हि ही हु हू हृ हॅ हे है हॉ हो हौ हँ हं हः क़ा क़ि क़ी क़ु क़ू क़ृ क़ॅ क़े क़ै क़ॉ क़ो क़ौ क़ँ क़ं क़ः ख़ा ख़ि ख़ी ख़ु ख़ू ख़ृ ख़ॅ ख़े ख़ै ख़ॉ ख़ो ख़ौ ख़ँ ख़ं ख़ः ग़ा ग़ि ग़ी ग़ु ग़ू ग़ृ ग़ॅ ग़े ग़ै ग़ॉ ग़ो ग़ौ ग़ँ ग़ं ग़ः ज़ा ज़ि ज़ी ज़ु ज़ू ज़ृ ज़ॅ ज़े ज़ै ज़ॉ ज़ो ज़ौ ज़ँ ज़ं ज़ः ड़ा ड़ि ड़ी ड़ु ड़ू ड़ृ ड़ॅ ड़े ड़ै ड़ॉ ड़ो ड़ौ ड़ँ ड़ं ड़ः ढ़ा ढ़ि ढ़ी ढ़ु ढ़ू ढ़ृ ढ़ॅ ढ़े ढ़ै ढ़ॉ ढ़ो ढ़ौ ढ़ँ ढ़ं ढ़ः फ़ा फ़ि फ़ी फ़ु फ़ू फ़ृ फ़ॅ फ़े फ़ै फ़ॉ फ़ो फ़ौ फ़ँ फ़ं फ़ः ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz"
print(_characters)
_punctuations = "!'(),-.:;—?\"\”\“\'? \”\ ..."
...
_vowels = "iyɨʉɯuɪʏʊeøɘəɵɤoɛœɜɞʌɔæɐaɶɑɒᵻ"
_non_pulmonic_consonants = "ʘɓǀɗǃʄǂɠǁʛ"
_pulmonic_consonants = "pbtdʈɖcɟkɡqɢʔɴŋɲɳnɱmʙrʀⱱɾɽɸβfvθðszʃʒʂʐçʝxɣχʁħʕhɦɬɮʋɹɻjɰlɭʎʟʰ'̃"
_suprasegmentals = "ˈˌːˑ'̩"
_other_symbols = "ʍwɥʜʢʡɕʑɺɧʲ"
_diacrilics = "ɚ˞ɫ"
_phonemes = _vowels + _non_pulmonic_consonants + _pulmonic_consonants + _suprasegmentals + _other_symbols + _diacrilics
