...
from .hindi.number_norm import normalize_numbers as hi_normalize_numbers
from .french.abbreviations import abbreviations_fr
from .hindi.abbreviations import abbreviations_hi
...
def expand_abbreviations(text, lang="en"):
    if lang == "en":
        ...
        _abbreviations = abbreviations_hi
...
def hindi_cleaners(text):
    text = hi_normalize_numbers(text)
    text = expand_abbreviations(text)
    text = replace_symbols(text)
    text = remove_aux_symbols(text)
    text = collapse_whitespace(text)
