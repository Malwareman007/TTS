...
class VitsConfig(BaseTTSConfig):
    ...
    lr_gen: float = 0.0002
    lr_disc: float = 0.0002
    # lr_gen: float = 0.0001907692176976117 
    # lr_disc: float = 0.00019076921769761162
    ...
    test_sentences: List[List] = field(
        default_factory=lambda: [
            ["नमस्ते राजन, आपका लिवर किडनी पैनल, सात अक्टूबर को टेस्ट हुआ था।"],
            ["चलिए आपकी रिपोर्ट को, अच्छे से समझते हैं।"],
            ["हमारे परीक्षणों में, पन्द्रह मापदंडों को, सामान्य और स्वस्थ पाया गया है, और दो क्षेत्रों में गैर-इष्टतम स्तर पाया गया है।"],
            ["इसके साथ ही, आपको अपने जीजीटीपी लैवल पर ध्यान देने की जरूरत है।"],
        ]
    )
